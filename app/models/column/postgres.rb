...
class Column
  module Postgres
    ...
    included do
      ...
      after_create :add_pg_table_column, unless: :builtin?
      before_update :update_pg_table_constraints # TODO: Improve this, some builtin column allow edit constraint

      after_commit :add_or_remove_pg_table_index, unless: :builtin?
      after_commit :remove_pg_table_column, on: :destroy, unless: :builtin?
