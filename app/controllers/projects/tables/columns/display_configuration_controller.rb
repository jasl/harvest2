...
class Projects::Tables::Columns::DisplayOptionsController < Projects::Tables::Columns::ApplicationController
  before_action :set_configuration, only: %i[edit update]

  def edit
    prepare_meta_tags title: "Display"
    @_breadcrumbs << { text: "Display" }
  end
  ...
  private
    ...
    def set_configuration
      @configuration = @column.display_configuration
    end
